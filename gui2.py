...
class InferenceThread(threading.Thread):
    def __init__(self,stop_event,counton,helmeton):
        super().__init__()
    ...
    def run(self):
        ...
        video = cv2.VideoCapture("Videos\helm1e1.mp4")
        video.set(3, 1280)
        video.set(4, 740)
        # Tracking
...
while True:
    ...
    if event == 'Run' :
        ...
        if inference_thread and inference_thread.is_alive():
            ...
            inference_thread = InferenceThread(stop_event,run_counting,run_helmet)
